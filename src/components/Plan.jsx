...
import { FaMapMarkerAlt, FaUndo, FaTrash, FaPaperPlane } from 'react-icons/fa';
    ...
    <div>
        ...
        <div className="map-container">
            ...
            <div className="fly-options">
                <div className="fly-btn">
                    <FaPaperPlane className="" />
                    <div>Fly</div>
                </div>

                <div className="mark-btn" onClick={() => setShowPlan(!showPlan)}>
                    <FaMapMarkerAlt className="" />
                    <div>Mark</div>
                </div>

                <div className="takeoff-btn" onClick={() => { setCurrentWaypointIndex(0); setIsMoving(true); }}>
                    <FaArrowTurnUp className="" />
                    <div>Take Off</div>
                </div>

                <div className="return-btn" onClick={handleReturnClick}>
                    <FaArrowTurnDown className="" />
                    <div>Return</div>
                </div>
